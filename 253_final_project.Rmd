...
Our goal for this project is to create the best model to predict division one college basketball wins using extremely common statistics often included in basketball datasets. 
